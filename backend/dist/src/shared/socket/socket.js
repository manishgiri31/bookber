...
import { OPS_NAMESPACE, REALTIME_NAMESPACE, SOCKET_HEARTBEAT_MS, SOCKET_STALE_MS, SOCKET_STALE_SWEEP_MS } from "./socket.config.js";
...
export function createSocketInfrastructure(app) {
    ...
    const stopStaleRealtime = startStaleSocketCleanup(realtimeNsp, SOCKET_STALE_MS, SOCKET_STALE_SWEEP_MS, (socketId) => {
