...
export class QueueEntryMigration {
    ...
    async migrate() {
        ...
        try {
            ...
            const queueEntryCountResult = await prisma.$queryRaw `
      ...
      `;
          ...
          `;
            ...
            const queueEntryCountResult2 = await prisma.$queryRaw `
        SELECT COUNT(*) as count FROM "QueueEntry"
      `;
            const activeQueueCountResult = await prisma.$queryRaw `
    ...
    async verify() {
        ...
        try {
            ...
            const queueEntryCount = await prisma.$queryRaw `
        SELECT COUNT(*) as count FROM "QueueEntry"
      `;
      ...
      `;
            ...
            try {
                const activeQueueCount = await prisma.$queryRaw `
          SELECT COUNT(*) as count FROM "ActiveQueue"
        `;
            ...
            try {
                const bookingWithQueueFields = await prisma.$queryRaw `
