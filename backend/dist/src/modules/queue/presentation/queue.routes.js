...
export const queueRoutes = async (app) => {
    ...
    app.post("/shops/:shopId/wait-estimates/recalculate", { preHandler: app.authorizeRoles(["BARBER", "ADMIN"]) }, waitTimeController.recalculate);
    app.post("/shops/:shopId/barbers/:barberId/delay", { preHandler: app.authorizeRoles(["BARBER", "ADMIN"]) }, waitTimeController.reportBarberDelay);
    app.post("/shops/:shopId/barbers/:barberId/overrun", { preHandler: app.authorizeRoles(["BARBER", "ADMIN"]) }, waitTimeController.reportOverrun);
};
