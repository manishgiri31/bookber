...
export class QueuePositionService {
     ...
     */
    async getNextPosition(shopId, lane, insertAfterPosition = null) {
     ...
     */
    async normalizeLane(shopId, lane) {
        return this.lock.withLock(`shop:${shopId}:normalize`, 8000, async () => prisma.$transaction(async (tx) => {
