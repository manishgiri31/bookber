...
export class RecoveryOrchestrator {
    ...
    cleanupFunctions = [];
    isRunning = false;
    constructor(lock, config = {}, redis = null, waitTimeEngine = null) {
     ...
     */
    start(redis = null, waitTimeEngine = null, socketManager = null) {
        if (this.isRunning) {
     ...
     */
    async runOnce(redis = null, waitTimeEngine = null, socketManager = null) {
     ...
     */
    aggregateStats(aggregate, individual) {
     ...
     */
    async getHealthStats(redis = null, socketManager = null) {
