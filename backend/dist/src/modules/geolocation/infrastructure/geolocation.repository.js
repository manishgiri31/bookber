...
export class PrismaGeolocationRepository {
    ...
    async findNearbyShops(params) {
        const { latitude, longitude, radius = 10, // default 10km
        city, minRating, acceptingBookings, acceptingWalkIns, premiumOnly, maxWaitMinutes, sortBy = 'distance', // default sort by distance
